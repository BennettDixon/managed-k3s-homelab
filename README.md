...
| `services/` | Service source code: `jobs-mcp` (task queue), `knowledge-mcp` (retrieval), `gateway` (model gateway — live at `http://gateway/v1` since 2026-09-14, metered lane only) |
